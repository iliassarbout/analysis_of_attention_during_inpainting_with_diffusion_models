...
def load_data_inpa(
    ...
    ** kwargs
    ...
    if len(gt_paths)<len(mask_paths): #!modif : allow to have more masks in the folder. Usefull because we may generate generic masks to apply to different datasets.
